...
//go:cgo_import_dynamic imp_libc_getifaddrs getifaddrs "libc.so.0.3"
//go:cgo_import_dynamic imp_libc_freeifaddrs freeifaddrs "libc.so.0.3"
//go:cgo_import_dynamic imp_libc_if_nametoindex if_nametoindex "libc.so.0.3"
...
//go:cgo_import_dynamic imp_libc_getsid getsid "libc.so.0.3"
...
func Getifaddrs(ifap **Ifaddrs) (err error) {
	_, _, e1 := syscall6(uintptr(unsafe.Pointer(&libc_getifaddrs)), 1, uintptr(unsafe.Pointer(ifap)), 0, 0, 0, 0, 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func Freeifaddrs(ifa *Ifaddrs) {
	syscall6(uintptr(unsafe.Pointer(&libc_freeifaddrs)), 1, uintptr(unsafe.Pointer(ifa)), 0, 0, 0, 0, 0)
	return
}
// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT


func Ifnametoindex(name *byte) (index uint32) {
	r0, _, _ := syscall6(uintptr(unsafe.Pointer(&libc_if_nametoindex)), 1, uintptr(unsafe.Pointer(name)), 0, 0, 0, 0, 0)
	index = uint32(r0)
	return
}
// THIS FILE IS GENERATED BY THE COMMAND AT THE TOP; DO NOT EDIT
...
func Getsid(pid int) (sid int, err error) {
	r0, _, e1 := syscall6(uintptr(unsafe.Pointer(&libc_getsid)), 1, uintptr(pid), 0, 0, 0, 0, 0)
	sid = int(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
