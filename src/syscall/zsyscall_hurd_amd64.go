// mksyscall_libc.pl -aix -tags hurd,amd64 syscall_hurd.go syscall_hurd_amd64.go
...
func Ftruncate(fd int, length int64) (err error) {
	_, _, e1 := syscall6(uintptr(unsafe.Pointer(&libc_ftruncate64)), 2, uintptr(fd), uintptr(length), 0, 0, 0, 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
...
func pread(fd int, p []byte, offset int64) (n int, err error) {
	...
	r0, _, e1 := syscall6(uintptr(unsafe.Pointer(&libc_pread64)), 4, uintptr(fd), uintptr(unsafe.Pointer(_p0)), uintptr(len(p)), uintptr(offset), 0, 0)
	n = int(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
...
func pwrite(fd int, p []byte, offset int64) (n int, err error) {
	...
	r0, _, e1 := syscall6(uintptr(unsafe.Pointer(&libc_pwrite64)), 4, uintptr(fd), uintptr(unsafe.Pointer(_p0)), uintptr(len(p)), uintptr(offset), 0, 0)
	n = int(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
...
func Seek(fd int, offset int64, whence int) (newoffset int64, err error) {
	r0, _, e1 := syscall6(uintptr(unsafe.Pointer(&libc_lseek64)), 3, uintptr(fd), uintptr(offset), uintptr(whence), 0, 0, 0)
	newoffset = int64(r0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
...
func Truncate(path string, length int64) (err error) {
	...
	_, _, e1 := syscall6(uintptr(unsafe.Pointer(&libc_truncate64)), 2, uintptr(unsafe.Pointer(_p0)), uintptr(length), 0, 0, 0, 0)
	if e1 != 0 {
		err = errnoErr(e1)
	}
	return
